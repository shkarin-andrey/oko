...
const Hamburger: FC<IHamburger> = ({ isOpenMenu, onClick }) => {
  const classNameIsOpenMenu = isOpenMenu
    ? 'invisible after:visible before:visible before:rotate-45 after:-rotate-45 after:-translate-y-0.5 before:-translate-y-0.5'
  ...
  return (
    <div
      onClick={onClick}
      aria-hidden
      className='lg:hidden w-6 flex flex-col justify-center h-6 relative cursor-pointer'
    >
      <div
